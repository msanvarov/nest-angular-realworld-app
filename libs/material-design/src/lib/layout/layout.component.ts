...
import { FuseConfigService } from '@starter/config';
import { FuseMediaWatcherService } from '@starter/media-watcher';
import { AppConfig, Layout } from '@starter/ui-types';
import { FUSE_VERSION } from '@starter/version';

@Component({
  selector: 'starter-layout',
